      ...
      <div className="section-width py-20 flex flex-col items-center justify-center gap-16 pt-35">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-lg lg:text-base max-w-full md:max-w-xl text-white/80">
            ...
            left waiting. You can also follow me on social media to stay
            connected, get updates, or reach out there if you prefer.
          </p>
        </div>
        <div className="flex flex-col md:flex-row items-start justify-evenly gap-20 w-full">
          <div className="flex flex-col items-start justify-center gap-12">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://instagram.com/rfwebpro"
                target="_blank"
              ...
              <div className="flex flex-col items-start justify-center gap-2">
                ...
                <p className="text-white/80">@rfwebpro</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <a
                href="https://www.tiktok.com/@rfwebpro"
                target="_blank"
                className="flex-shrink-0"
              >
                <svg
